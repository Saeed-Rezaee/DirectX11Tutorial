...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPTSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	{
		SVertex2D(XMFLOAT2(-0.5f, 0.5f), XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f)),
		SVertex2D(XMFLOAT2(0.5f, 0.5f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f)),
		SVertex2D(XMFLOAT2(-0.5f, -0.5f), XMFLOAT4(0.0f, 1.0f, 0.0f, 1.0f)),
		SVertex2D(XMFLOAT2(0.5f, -0.5f), XMFLOAT4(0.0f, 0.0f, 1.0f, 1.0f)),
	};
